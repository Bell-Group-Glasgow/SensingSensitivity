...
def user_zoom_mult(results, xlim=(600, 4000), ylim=(-0.015, 0.015), zoom_dir_name="Zoomed"):
    ...
    while True:
        ...
        user_input = input("Do you want to zoom in to a region on the spectrum? (y/n): ").lower()
