    ...
    for file in os.listdir(folder_path):
        if file.lower().endswith(".csv"):
            ...
            try:
                ...
                plt.figure()
                plt.scatter(
                    elapsed_minutes, intensities, color=color, label="Data"
                )
                plt.plot(
                    elapsed_minutes,
                    trendline,
    ...
    for file in sorted(os.listdir(folder_path)):
        if file.lower().endswith(".csv"):
            ...
            try:
                ...
                add_trendline_with_stats(
                    elapsed_minutes,
                    intensities,
                    color,
                    label_offset=(10, offset_y),
                )
...
plot_all_peaks_combined(
    react_csv_dir,
    max_colours_react,
    title="Combined Peak Intensities - Reactants w Linear Trends",
)
plot_all_peaks_combined(
    prod_csv_dir,
    max_colours_prod,
    title="Combined Peak Intensities - Products w Linear Trends",
)
