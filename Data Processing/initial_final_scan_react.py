...
def plot_final_scan(csv_files, data_proc_plot_dir):
    ...
    plt.figure()
    plt.plot(df_subtracted_final['Wavenumbercm-1'], df_subtracted_final['Intensity'], color=color)
...
def plot_product_scan(csv_files, data_proc_plot_dir):
    ...
    plt.figure()
    plt.plot(df_subtracted_prod['Wavenumbercm-1'], df_subtracted_prod['Intensity'], color=color)
